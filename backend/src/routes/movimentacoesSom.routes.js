 ...
 */
movimentacoesSomRouter.post('/', async (req, res, next) => {
  try {
    ...
    if (tipoRaw === 'entrada') tipoDbValue = 'ENTRADA'; // troque para minúsculo se seu ENUM for minúsculo
 ...
 */
movimentacoesSomRouter.delete('/:id', requireAdmin, async (req, res, next) => {
  try {
